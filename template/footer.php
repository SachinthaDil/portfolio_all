<div class="footer1">
        ...
        <div class="infoo">
            <h3 style="color: white;">© 2023 Freelancer - Crafted with passion and creativity by Hammad.</h3>
        </div>
        <div class="otheracc">
            ...
            <div class="elementor-grid-item">
                <a class="elementor-icon elementor-social-icon elementor-social-icon-behance elementor-repeater-item-45053c6"
                    href="#" target="_blank">
